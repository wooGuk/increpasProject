...
public class Paging_game {
	...
	// 페이지 값을 연산하기 위한 생성자
	public Paging_game(int nowPage, int rowTotal, int blockList, int blockPage) {
