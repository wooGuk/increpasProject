...
public class Paging_gameScedule {
	...
	// 페이지 값을 연산하기 위한 생성자
	public Paging_gameScedule(int nowPage, int rowTotal, int blockList, int blockPage) {
		...
		if (isPrePage) {
			...
			sb.append("gamescedule.inc?nowPage=");
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == nowPage) {
				...
				sb.append("&nbsp;<a href='gamescedule.inc?");
				sb.append("nowPage=");
